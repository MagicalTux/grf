...
int main(int argc, char *argv[]) {
	...
	if (grf_version() < (0x11b)) { // 0.1.27
		QMessageBox::warning(NULL, "GrfBuilder", "I need at least libgrf v0.1.27 to run. Make sure you have the last one installed.", QMessageBox::Cancel, QMessageBox::Cancel);
		return 1;
	}
